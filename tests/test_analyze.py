...
def test_format_context_includes_key_facts():
    ctx = {
        "event": {
            "ticker": "GS", "asset": "Goldman Sachs", "txn_type": "purchase",
            "txn_date": "2026-04-16", "disclosure_date": "2026-05-05", "delay_days": 19,
        ...
        "history": {
            ...
            "median_delay_days": 22, "trades_last_90d": 50,
        },
        "as_of": "2026-05-05",
    }
...
def test_format_context_handles_missing_sector_and_history():
    ctx = {
        "event": {
            "ticker": None, "asset": "US Treasury Bill", "txn_type": "sale",
            "txn_date": "2025-01-01", "disclosure_date": "2025-01-20", "delay_days": 19,
            "amount_low": 50001, "amount_high": None,
        },
        "member": None, "asset_sector": None, "history": None, "as_of": "2025-01-20",
    }
    s = format_context(ctx)
